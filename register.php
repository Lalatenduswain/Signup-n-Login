...
<head>
    ...
    <script>
        function generateCaptcha() {
            ...
            document.getElementById("captcha-first").textContent = firstNumber;
            document.getElementById("captcha-second").textContent = secondNumber;
            document.getElementById("captcha-sum").value = sum;
        }

        function validateCaptcha() {
            var answer = parseInt(document.getElementById("captcha-answer").value);
            var sum = parseInt(document.getElementById("captcha-sum").value);
            ...
            <div class="col-lg-5">
                <div class="form-wrap border rounded p-4">
                    ...
                    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
                        ...
                        <div class="mb-3">
                            <label for="captcha" class="form-label">Captcha: What is
                                <span id="captcha-first"><?= rand(0, 9); ?></span> + <span
                                    id="captcha-second"><?= rand(0, 9); ?></span> ?
                            </label>
                            <input type="hidden" id="captcha-sum" value="">
